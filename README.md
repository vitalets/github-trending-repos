...
3. Every hour the automatic script checks GitHub trending repos and drops an issue comment if there is something new.
   As a subscriber you receive GitHub notification in web interface <img alt="subscribe button" valign="text-bottom" src="https://user-images.githubusercontent.com/1473072/32723023-01555c78-c87d-11e7-8190-6bf3bb0ec405.png"> or by email.  Example of web notification:  
